 ...
 */
class ZanuiFixturesExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('base_order_fallback', $config['base_order_fallback']);

        if (isset($config['entity_namespace_fallback'])) {
            $container->setParameter('entity_namespace_fallback', $config['entity_namespace_fallback']);
        }
    }
}
